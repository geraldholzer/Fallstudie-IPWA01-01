...
<div class ="ccontent">
  <!-- CO2Tabelle -->
  <CoTable titel="Amerika" quelle="amerika.json"></CoTable>
  <!-- CO2Tabelle -->
...
<a class= "clokallink" href="#sprungspezifisch">Emmisionen Amerika</a>
...
@media screen and (max-width: 500px){
 #app{  grid-template-rows:20rem 1fr;
  display:grid;
  justify-self:center;
} 
.cnavil{
